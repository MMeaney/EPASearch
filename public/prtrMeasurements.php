...
<span class="pull-right">
	<button type="button" id="btnPRTRMeasurementsQueryJSONHide" class="btn btn-info btn-xs">Hide</button>
	<button type="button" id="btnPRTRMeasurementsQueryJSONShow" class="btn btn-info btn-xs">Show</button>
</span><!-- ./pull-right -->

</div><!-- ./panel-heading -->

<div id="divPRTRMeasurementsQueryJSONHideShow">
<div class="panel-body" id="divRefinePanelBody">
<div id="divPanelRefineResultsSpacer"></div>
<pre>
<code class="language-json">
<?php 
echo json_encode($paramPRTRMeasurements['body'], JSON_PRETTY_PRINT);
?>
</code></pre>
<div id="divPanelRefineResultsSpacer"></div>
</div><!-- ./panel-body (#divRefinePanelBody) -->
</div><!-- ./divPRTRMeasurementsQueryJSONHideShow --> 
</div><!-- /.panel-default --> 
