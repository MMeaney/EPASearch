...
<?php
	...
	<tr>
		...
		<td><a href="./leapViewComplaint.php?id=<?php echo $result['_id']; ?>&routing=<?php echo $result['_routing']; ?>">
			<?php echo $searchResult['epa_casenumber']; ?></a></td>
		<td><a href="?q=<?php echo $searchResult['lema_licenseregnumber']; ?>&submitted=true" onclick="form.submit();"><?php echo $searchResult['lema_licenseregnumber']; ?></a></td>
...
<span class="pull-right">
	<button type="button" id="btnLEAPComplaintQueryJSONHide" class="btn btn-info btn-xs">Hide</button>
	<button type="button" id="btnLEAPComplaintQueryJSONShow" class="btn btn-info btn-xs">Show</button>
</span><!-- ./pull-right -->

</div><!-- ./panel-heading -->

<div id="divLEAPComplaintQueryJSONHideShow">
<div class="panel-body" id="divRefinePanelBody">
<div id="divPanelRefineResultsSpacer"></div>
<pre>
<code class="language-json"><?php echo $paramLEAPComplaint['body']; ?>
<?php /*echo json_encode($paramLEAPComplaint['body'], JSON_UNESCAPED_SLASHES);*/?>
</code></pre>
<div id="divPanelRefineResultsSpacer"></div>
</div><!-- ./panel-body (#divRefinePanelBody) -->
</div><!-- ./divLEAPComplaintQueryJSONHideShow --> 
</div><!-- /.panel-default --> 
