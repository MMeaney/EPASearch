...
<title>LEAP Complaint <?php echo $searchResult['epa_casenumber'] ?></title>
...
<div class="row">
	<font size="3"><div class="col-sm-2"><b>Complaint Number: </b></div>
	<div class="col-sm-6"><?php echo $searchResult['epa_casenumber']; ?></div></font>
</div>
...
<div class="row">
	...
	<div class="col-sm-4"><?php echo $searchResult['lema_licenselocalauthority']; ?></div>
</div>
...
<div class="row">
	...
	<div class="col-sm-4"><?php echo $searchResult['epa_licencename']; ?></div>
	<div class="col-sm-2"><b>Licence Reg No: </b></div>
	<div class="col-sm-4"><?php echo $searchResult['lema_licenseregnumber']; ?></div>
</div>

<br />


<h4 id="leapReportDelimiter">Complainant Details </h4>


<div class="row">
	<div class="col-sm-2"><b>Complainant Name: </b></div>
	<div class="col-sm-4"><?php 
	if($searchResult['epa_confidential'] == true) {
		echo "Confidential";
	}
	else {
		echo $searchResult['epa_complainantidname'];
	} ?></div>
	<div class="col-sm-2"><b>Confidential: </b></div>
...
<div class="row">
	<div class="col-sm-2"><b>Complainant Address: </b></div>
	<div class="col-sm-4"><?php 
	if($searchResult['epa_confidential'] == true){
		echo "Confidential";
	}
	else {
		echo $searchResult['epa_complainantaddress1']; 
	}?></div>
	...
	if($searchResult['epa_confidential'] == true){
		...
		echo $searchResult['epa_complainanttelephonenumber']; 
	}?></div>
</div>
...
<div class="row">
	...
	if($searchResult['epa_confidential'] == true){
		...
		echo $searchResult['epa_complainantaddress2']; 
	}?></div>
	...
	if($searchResult['epa_confidential'] == true){
		...
		echo $searchResult['epa_complainantmobilephoneno']; 
	}?></div>
</div>
...
<div class="row">
	...
	if($searchResult['epa_confidential'] == true){
		...
		if(!empty($searchResult['epa_complainantaddress3'])){
			echo $searchResult['epa_complainantaddress3'];
		}
		else {
	...
	<a href="mailto:"<?php echo $searchResult['epa_complainantemailaddress']; ?>"><?php echo $searchResult['epa_complainantemailaddress']; }?></a></div>
</div>
...
<h4 id="leapReportDelimiter">Complaint Details </h4>


<div class="row">
	<div class="col-sm-2"><b>Complaint Source: </b></div>
	<div class="col-sm-4"><?php 
	if($searchResult['epa_confidential'] == true){
		echo "Confidential";
	}
