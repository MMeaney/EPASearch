...
<tr>
	...
	if (strpos($searchResultLEAPDocURL, 'SHA')!==false){
		...
		$displayLEAPSHA_REF = $displaySHAType;		
    } // END Check If SHA
	...
	if (strpos($searchResultLEAPDocURL, 'Complaints')!==false){
		...
		$displayLEAPSHA_REF = $leapDocComplaint;
	...
	if (strpos($searchResultLEAPDocURL, 'Incident')!==false){
		...
		$displayLEAPSHA_REF = $leapDocINCI;
	...
	if (strpos($searchResultLEAPDocURL, 'Licensee Returns')!==false){
		...
		$displayLEAPSHA_REF = $leapDocLR;
    } // END Check If Licensee Returns
	?>	
	<a href="?q=<?php echo $displayLEAPSHA_REF; ?>&submitted=true" onclick="form.submit();"><?php echo $displayLEAPSHA_REF; ?></a>
